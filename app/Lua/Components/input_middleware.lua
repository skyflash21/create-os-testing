...
function module:switch_to_hybrid_screen()
    ...
    self:switch_to_virtual_input(true, true)

    self.mode = "hybrid"
end

function module:switch_to_virtual_screen()
    self:switch_to_virtual_input(false, true)

    self.mode = "virtual"
end

function module:switch_to_virtual_input(print_local, print_remove)
